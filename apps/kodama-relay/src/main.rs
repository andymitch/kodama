//! Kodama Standalone Relay
//!
//! Lightweight frame forwarder. Accepts camera connections, broadcasts frames
//! to connected clients. No storage, no command routing, no rate limiting.
//!
//! Optionally forwards frames to an upstream server when `KODAMA_UPSTREAM_KEY` is set.
//!
//! ## Usage
//!
//! ```bash
...
//! KODAMA_UPSTREAM_KEY=<server_key> kodama-relay
//! ```
