...
//! kodama-desktop --save-frames /tmp/kodama-frames
//!
...
//! It displays per-channel statistics and decoded telemetry data.
...
use kodama::{Channel, Frame, Relay, SourceId};
use kodama::capture::{decode_telemetry, TelemetryData};
